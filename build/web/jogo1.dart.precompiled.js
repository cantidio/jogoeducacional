...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|Blob|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["gorgon", "package:gorgon/gorgon.dart", , M, {
  "^": "",
  AudioChannel: {
    "^": "Object;_context,_gain,_muteGain,_instances",
    _removeFinishedInstances$0: function() {
      var t1, i, t2, t3, t4;
      for (t1 = this._instances, i = t1.length - 1; i >= 0; --i) {
        if (i >= t1.length)
          return H.ioore(t1, i);
        t2 = t1[i];
        if (!t2._stopped) {
          ...
          t3.get$loop(t3);
          t3 = t2._source;
          t3 = t3.get$context(t3);
          t3 = t3.get$currentTime(t3);
          t4 = t2._start;
          t2 = t2._source;
          t2 = t2.get$buffer(t2);
          t3.$gt(0, t4.$add(0, t2.get$duration(t2)));
          t2 = false;
        } else
          t2 = false;
        if (t2) {
    ...
    _play$2: function(sound, looping) {
      var source, instance, t1;
      source = this._context.createBufferSource();
      source.buffer = sound._buffer;
      source.loop = looping;
      source.connect(sound._gain, 0, 0);
      C.AudioBufferSourceNode_methods.start$0(source);
      instance = new M.AudioInstance(null, null, null, null);
      instance.AudioInstance$_fromSource$2(source, sound._gain);
      t1 = this._instances;
      t1.push(instance);
      if (t1.length > 100)
        this._removeFinishedInstances$0();
      return instance;
    },
    setAsTarget$0: function() {
      $.AudioSystem__targetChannel = this;
    },
    AudioChannel$_$0: function() {
      var t1 = new (window.AudioContext || window.webkitAudioContext)();
      this._context = t1;
      t1 = J.createGain$0$x(t1);
      this._gain = t1;
      t1.connect(this._context.destination, 0, 0);
    }
  },
  AudioInstance: {
    "^": "Object;_source,_gain,_start,_stopped",
    AudioInstance$_fromSource$2: function(source, gain) {
      var t1;
      this._stopped = false;
      this._source = source;
      this._gain = gain;
      t1 = source.get$context(source);
      this._start = t1.get$currentTime(t1);
    }
  },
  AudioSystem: {
    "^": "Object;_channels",
    AudioSystem$_$0: function() {
      var t1, t2;
      t1 = this._channels;
      t2 = new M.AudioChannel(null, null, null, H.setRuntimeTypeInfo([], [M.AudioInstance]));
      t2.AudioChannel$_$0();
      t1.$indexSet(0, "default", t2);
      t1.$index(0, "default").setAsTarget$0();
    },
    static: {"^": "AudioSystem__singleton,AudioSystem__targetChannel"}
  },
  Sound: {
    "^": "Object;_channel,_gain,_buffer,_onLoad",
    load$1: function(_, soundUrl) {
      var completer, request, t1;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      request = new XMLHttpRequest();
      request.responseType = "arraybuffer";
      C.HttpRequest_methods.open$3$async(request, "GET", soundUrl, true);
      t1 = H.setRuntimeTypeInfo(new W._EventStream(request, "load", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Sound_load_closure(this, soundUrl, completer, request)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._EventStream(request, "error", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Sound_load_closure0(soundUrl, completer)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      request.send();
      t1 = completer.future;
      this._onLoad = t1;
      return t1;
    },
    Sound$2$channel$soundUrl: function(channel, soundUrl) {
      var t1 = $.AudioSystem__singleton;
      if (t1 == null) {
        t1 = new M.AudioSystem(P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, M.AudioChannel));
        t1.AudioSystem$_$0();
        $.AudioSystem__singleton = t1;
      }
      t1.toString;
      t1 = $.AudioSystem__targetChannel;
      this._channel = t1;
      t1 = J.createGain$0$x(t1._context);
      this._gain = t1;
      t1.connect(this._channel._gain, 0, 0);
      this.load$1(0, soundUrl);
    },
    static: {Sound$: function(channel, soundUrl) {
        var t1 = new M.Sound(null, null, null, H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]).future);
        t1.Sound$2$channel$soundUrl(channel, soundUrl);
        return t1;
      }}
  },
  Sound_load_closure: {
    "^": "Closure:10;this_0,soundUrl_1,completer_2,request_3",
    call$1: function(_) {
      var t1, t2;
      t1 = this.this_0;
      t2 = this.completer_2;
      J.decodeAudioData$1$x(t1._channel._context, W._convertNativeToDart_XHR_Response(this.request_3.response)).then$2$onError(new M.Sound_load__closure(t1, t2), new M.Sound_load__closure0(this.soundUrl_1, t2));
    },
    $isFunction: true
  },
  Sound_load__closure: {
    "^": "Closure:10;this_4,completer_5",
    call$1: function(buffer) {
      var t1 = this.this_4;
      t1._buffer = buffer;
      this.completer_5.complete$1(0, t1);
    },
    $isFunction: true
  },
  Sound_load__closure0: {
    "^": "Closure:10;soundUrl_6,completer_7",
    call$1: function(error) {
      this.completer_7.completeError$1(new P._ExceptionImplementation("Sound: Error when decoding " + this.soundUrl_6 + "."));
    },
    $isFunction: true
  },
  Sound_load_closure0: {
    "^": "Closure:10;soundUrl_8,completer_9",
    call$1: function(e) {
      this.completer_9.completeError$1(new P._ExceptionImplementation("Sound: " + this.soundUrl_8 + " could not be found."));
    },
    $isFunction: true
  }
}],
...
["", "jogo1.dart", , O, {
  ...
  main: [function() {
    var t1, t2, t3;
    $.get$backgoundsound()._onLoad.then$1(new O.main_closure());
    $.botao_0 = document.querySelector("#botao0");
    $.botao_1 = document.querySelector("#botao1");
    t1 = document.querySelector("#botao2");
    $.botao_2 = t1;
    t2 = $.botao_0.style;
    t3 = $.botao_1.style;
    ...
    t2 = J.get$onClick$x(document.querySelector("#continue"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(O.geraPagina$closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 1],
  geraPagina: [function(e) {
    var sorteados, t1, t2, t3, k, j, n, t4, t5, t6;
    J.set$display$x(document.querySelector("#continue").style, "none");
    sorteados = [];
    if ($.fase_atual < 11) {
      t1 = document.querySelector("#frases");
      t2 = $.get$fases_jogo();
      t3 = $.fase_atual;
      if (t3 >= 11)
      ...
      for (k = 0, j = -1; k < 3;) {
        n = C.C__JSRandom.nextInt$1(3);
        if (!C.JSArray_methods.contains$1(sorteados, n)) {
          ++j;
          t1 = n + $.i;
          if (j === 0) {
            t2 = $.botao_0;
            ...
            t2.textContent = t3[t1];
            J.set$display$x(t2.style, $.get$style_botao()[t1]);
            t3 = J.getInterceptor$x(t2);
            t3.set$value(t2, $.get$valor_botao()[t1]);
            t2 = t3.get$onClick(t2);
            t3 = t2._eventType;
            t4 = t2._useCapture;
            t5 = new W._EventStreamSubscription(0, t2._target, t3, W._wrapZone(O.valor$closure()), t4);
          ...
          if (j === 2) {
            ...
            t3 = t2._eventType;
            t1 = t2._useCapture;
            t4 = new W._EventStreamSubscription(0, t2._target, t3, W._wrapZone(O.valor$closure()), t1);
            ...
            if (t5 && t4._pauseCount <= 0) {
              ...
              t4.toString;
              if (t5)
                J._addEventListener$3$x(t4, t3, t2, t1);
            }
          }
          sorteados.push(n);
          ++k;
  ...
  }, "call$1", "geraPagina$closure", 2, 0, 6],
  valor: [function(e) {
    var t1, gameover;
    if (H.interceptedTypeCast(J.get$target$x(e), "$isButtonElement").value === "0") {
      $.corretos = $.corretos + 1;
      $.get$correctSound()._onLoad.then$1(new O.valor_closure());
      $.i = $.i + 3;
      t1 = $.fase_atual + 1;
      $.fase_atual = t1;
      if (t1 >= 11) {
        J.set$display$x(document.querySelector("#continue").style, "none");
        window.alert(C.JSInt_methods.toString$0($.corretos));
      }
      O.geraPagina(e);
    } else {
      t1 = $.vidas - 1;
      $.vidas = t1;
      if (t1 >= 0)
        $.get$errorSound()._onLoad.then$1(new O.valor_closure0());
      else {
        $.get$gameoverSound()._onLoad.then$1(new O.valor_closure1());
        J.set$display$x(document.querySelector("#jogo_todo").style, "none");
        gameover = W._ElementFactoryProvider_createElement_tag("div", null);
        J.set$text$x(gameover, "Voc\u00ea perdeu :(");
        document.body.appendChild(gameover);
      }
    }
  }, "call$1", "valor$closure", 2, 0, 6],
  main_closure: {
    "^": "Closure:10;",
    call$1: function(_) {
      var t1 = $.get$backgoundsound();
      return t1._channel._play$2(t1, true);
    },
    $isFunction: true
  },
  valor_closure: {
    "^": "Closure:10;",
    call$1: function(_) {
      var t1 = $.get$correctSound();
      return t1._channel._play$2(t1, false);
    },
    $isFunction: true
  },
  valor_closure0: {
...
;(function() {
  ...
  _.$isDuration = TRUE;
  _.$isObject = TRUE;
  M.AudioChannel.$isObject = TRUE;
  P.AudioBuffer.$isObject = TRUE;
  M.AudioInstance.$isObject = TRUE;
...
$.Expando__keyCount = 0;
$.AudioSystem__singleton = null;
$.AudioSystem__targetChannel = null;
...
Isolate.$lazy($, "texto_botao", "texto_botao", "get$texto_botao", function() {
  return ["Ro\u00e7ar com foice e enxada", "Aplicar v\u00e1rios inseticidas", "Colocar fogo", "Dividi-l\u00e1 em partes iguais", "Plantar todos os vegetais juntos no mesmo espa\u00e7o", "", "Com fertilizantes naturais, como o esterco de suas pr\u00f3prias galinhas", "Comprar Adubos", "N\u00e3o Adubar", "Plantar cada semente no seu lugar", "Plantar as sementes em qualquer lugar", "", "Molhar uma vez ao dia", "N\u00e3o molhar", "Molhar 4 vezes ao dia, com muita \u00e1gua", "Fazer uma cerca", "N\u00e3o fazer cerca, apenas observar", "", "Separar as folhas para comer no jantar", "Separar a raiz para comer no jantar.", "", "Utilizar o vegetal inteiro para alimentar seus animais", "Jogar fora suas folhas, e dar apenas o caule e a raiz aos seu animais.", "", "Usar as espigas para fazer fub\u00e1, e as folhas e caule para dar de alimento aos animais.", "Dispensar as espigas.", "", "Arrancar o p\u00e9 de cenoura inteiro e oferec\u00ea-lo aos seus bichos de estima\u00e7\u00e3o.", "Cortar apenas as folhas.", "", "Colher suas frutas.", "Dispenser suas frutas.", ""];
});
Isolate.$lazy($, "valor_botao", "valor_botao", "get$valor_botao", function() {
  return ["0", "Voc\u00ea errou! Isso acaba com o mato indesejado, mas polui o solo, o ar e a \u00e1gua.", "Voc\u00ea errou! Isso destr\u00f3i o matagal e os pequenos animais que vivem ali.", "0", "Voc\u00ea errou! Dessa forma um vegetal interfere no crescimento do outro.", "1", "0", "Voc\u00ea errou! Comprar abudos \u00e9 caro e Pedro n\u00e3o tem dinheiro.", "Voc\u00ea errou! Os vegetais v\u00e3o demorar demais a crescer.", "0", "Voc\u00ea errou! Voc\u00ea n\u00e3o pode misturar as sementes.", "1", "0", "Voc\u00ea errou! Se n\u00e3o molhar as sementes n\u00e3o ir\u00e3o germinar.", "Voc\u00ea errou! Se voc\u00ea molhar demais as sementes v\u00e3o apodrecer e n\u00e3o ir\u00e3o germinar.", "0", "Voc\u00ea errou! Assim seus animais ir\u00e3o estragar toda a ro\u00e7a", "1", "0", "Voc\u00ea errou! Raiz de couve n\u00e3o \u00e9 um alimento comum para n\u00f3s humanos", "1", "0", "Voc\u00ea errou! S\u00e3o nas folhas que se encontram os nutrientes principais da alface.", "1", "0", "Voc\u00ea errou! As espigas s\u00e3o ricas em carboidratos, que d\u00e1 energia a quem consome.", "1", "0", "Voc\u00ea errou! Pois a cenoura \u00e9 uma raiz onde se utiliza todo o vegetal, seja para servir os animais ou para nos servir.", "1", "0", "Voc\u00ea errou!", "1"];
});
Isolate.$lazy($, "style_botao", "style_botao", "get$style_botao", function() {
  return ["initial", "initial", "initial", "initial", "initial", "none", "initial", "initial", "initial", "initial", "initial", "none", "initial", "initial", "initial", "initial", "initial", "none", "initial", "initial", "none", "initial", "initial", "none", "initial", "initial", "none", "initial", "initial", "none", "initial", "initial", "none"];
});
Isolate.$lazy($, "fases_jogo", "fases_jogo", "get$fases_jogo", function() {
  return ["Primeiramente precisamos organizar a ro\u00e7a onde os vegetais ser\u00e3o plantados posteriormente. Qual a melhor op\u00e7\u00e3o?", "Agora vamos dividir a ro\u00e7a em 5 partes para plantarmos couve, alface, milho, cenoura e mel\u00e2ncia. O que fazer ent\u00e3o?", "Muito bem! Agora precisamos adubar a terra.", "Agora que adubamos a terra precisamos plantar as sementes.", "As sementes est\u00e3o plantadas. O que devemos fazer agora para as sementes germinarem?", "Precisamos agora cuidar dos vegetais que germinaram e est\u00e3o come\u00e7ando a crescer.", "Vamos fazer a colheita da couve!", "Vamos colher a alface agora?!", "Agora \u00e9 a vez do milho!", "...da cenoura", "E finalmente da mel\u00e2ncia"];
});
Isolate.$lazy($, "backgoundsound", "backgoundsound", "get$backgoundsound", function() {
  return M.Sound$(null, "resources/music/somjogo.wav");
});
Isolate.$lazy($, "correctSound", "correctSound", "get$correctSound", function() {
  return M.Sound$(null, "resources/music/correct.wav");
});
Isolate.$lazy($, "errorSound", "errorSound", "get$errorSound", function() {
  return M.Sound$(null, "resources/music/error.wav");
});
Isolate.$lazy($, "gameoverSound", "gameoverSound", "get$gameoverSound", function() {
  return M.Sound$(null, "resources/music/gameover.wav");
});
// Native classes
...
//# sourceMappingURL=jogo1.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function AudioChannel(_context, _gain, _muteGain, _instances) {
    this._context = _context;
    this._gain = _gain;
    this._muteGain = _muteGain;
    this._instances = _instances;
  }
  AudioChannel.builtin$cls = "AudioChannel";
  if (!"name" in AudioChannel)
    AudioChannel.name = "AudioChannel";
  $desc = $collectedClasses.AudioChannel;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AudioChannel.prototype = $desc;
  function AudioInstance(_source, _gain, _start, _stopped) {
    this._source = _source;
    this._gain = _gain;
    this._start = _start;
    this._stopped = _stopped;
  }
  AudioInstance.builtin$cls = "AudioInstance";
  if (!"name" in AudioInstance)
    AudioInstance.name = "AudioInstance";
  $desc = $collectedClasses.AudioInstance;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AudioInstance.prototype = $desc;
  function AudioSystem(_channels) {
    this._channels = _channels;
  }
  AudioSystem.builtin$cls = "AudioSystem";
  if (!"name" in AudioSystem)
    AudioSystem.name = "AudioSystem";
  $desc = $collectedClasses.AudioSystem;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AudioSystem.prototype = $desc;
  function Sound(_channel, _gain, _buffer, _onLoad) {
  ...
  function Sound_load_closure(this_0, soundUrl_1, completer_2, request_3) {
    this.this_0 = this_0;
    this.soundUrl_1 = soundUrl_1;
    this.completer_2 = completer_2;
    this.request_3 = request_3;
  }
  Sound_load_closure.builtin$cls = "Sound_load_closure";
  if (!"name" in Sound_load_closure)
    Sound_load_closure.name = "Sound_load_closure";
  $desc = $collectedClasses.Sound_load_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Sound_load_closure.prototype = $desc;
  function Sound_load__closure(this_4, completer_5) {
    this.this_4 = this_4;
    this.completer_5 = completer_5;
  }
  Sound_load__closure.builtin$cls = "Sound_load__closure";
  if (!"name" in Sound_load__closure)
    Sound_load__closure.name = "Sound_load__closure";
  $desc = $collectedClasses.Sound_load__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Sound_load__closure.prototype = $desc;
  function Sound_load__closure0(soundUrl_6, completer_7) {
    this.soundUrl_6 = soundUrl_6;
    this.completer_7 = completer_7;
  }
  Sound_load__closure0.builtin$cls = "Sound_load__closure0";
  if (!"name" in Sound_load__closure0)
    Sound_load__closure0.name = "Sound_load__closure0";
  $desc = $collectedClasses.Sound_load__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Sound_load__closure0.prototype = $desc;
  function Sound_load_closure0(soundUrl_8, completer_9) {
    this.soundUrl_8 = soundUrl_8;
    this.completer_9 = completer_9;
  }
  Sound_load_closure0.builtin$cls = "Sound_load_closure0";
  if (!"name" in Sound_load_closure0)
    Sound_load_closure0.name = "Sound_load_closure0";
  $desc = $collectedClasses.Sound_load_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Sound_load_closure0.prototype = $desc;
